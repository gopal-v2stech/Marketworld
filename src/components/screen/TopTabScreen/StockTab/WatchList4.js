...
export default function WatchList4(props) {
    ...
    //                 return (value.watchListKey==='watchList 4');
    //             });
    ...
    //             return (stockName.includes(tempupper) && value.watchListKey==='watchList 4');
    //         });
    //         setStockData(filterlist);
    //     }
    ...
    return (
        ...
        <View style={{flex:1,backgroundColor:"white"}}>
            <WatchlistCommon watchlistName='watchList 4' renderHeader={props.renderHeader} userData={props.userData} stockListLength={props.stockListLength} searchValue={props.searchValue} />
        </View>
        // <View style={{flex:1,backgroundColor:"white"}}>
        //     {props.renderHeader}
        // {renderequityStocks()}
