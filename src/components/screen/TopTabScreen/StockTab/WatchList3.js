...
export default function WatchList3(props) {
    ...
    //                 return (value.watchListKey==='watchList 3');
    //             });
    ...
    //             return (stockName.includes(tempupper) && value.watchListKey==='watchList 3');
    //         });
    //         setStockData(filterlist);
    //     }
    ...
    return (
        ...
        <View style={{flex:1,backgroundColor:"white"}}>
            <WatchlistCommon watchlistName='watchList 3' renderHeader={props.renderHeader} userData={props.userData} stockListLength={props.stockListLength} searchValue={props.searchValue} />
        </View>
    )
