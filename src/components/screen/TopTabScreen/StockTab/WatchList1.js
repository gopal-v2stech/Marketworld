...
export default function WatchList1(props) {
    ...
    //                 return (value.watchListKey==='watchList 1');
    //             });
    ...
    //             return (stockName.includes(tempupper) && value.watchListKey==='watchList 1');
    //         });
    //         setStockData(filterlist);
    //     }
    ...
    return (
        <View style={{flex:1,backgroundColor:"white"}}>
            <WatchlistCommon watchlistName='watchList 1' renderHeader={props.renderHeader} userData={props.userData} stockListLength={props.stockListLength} searchValue={props.searchValue} />
        </View>
    )
